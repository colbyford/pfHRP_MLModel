...
## pip install -U azureml-dataprep --user
...
experiment_name = 'automl-pfHRP2'
# project folder
project_folder = './aml_project/automl-pfHRP2'
...
## From .csv
# dataset = pd.read_csv("pfHRP2_withMeta.csv")
# X_train = dataset[dataset.columns[5:29]]
# y_train = dataset[dataset.columns[34]]
# y_train = dataset[['PfHRP2']]

## From Dataset
from azureml.core import Dataset
dataset = Dataset.get_by_name(ws, name='pfHRP2_withMeta')
